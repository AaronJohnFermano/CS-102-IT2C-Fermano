...
Link1 <- "https://www.amazon.co.uk/s?k=Watch&crid=3P7G4EVHY387&sprefix=watc%2Caps%2C448&ref=nb_sb_noss_2"
session <- bow(Link1, user_agent = "Educational Purposes")
...
WatchProducts <- rbind(WatchProducts,data.frame
                       (Name = WatchName2,
                        Price = WatchPrice2,
                        No.Ratings = WatchRatings2,
                        Ratings = WatchReviews2))
...
WatchProducts <- rbind(WatchProducts,data.frame
                       (Name = WatchName3,
                        Price = WatchPrice3,
                        No.Ratings = WatchRatings3,
                        Ratings = WatchReviews3))
##
View(WatchProducts)
##
```
